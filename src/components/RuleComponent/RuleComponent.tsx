    ...
    <section className=" w-[88%] mx-auto my-8">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>{decodeURIComponent(ruleKey)}</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <section className="mt-4 bg-[#f5f5f5] border border-1 rounded-md p-6 dark:bg-card_color_dark dark:text-text_color_light">
        {/* Rule Details */}
        <div>
